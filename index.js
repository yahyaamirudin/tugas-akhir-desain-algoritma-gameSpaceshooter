...
const openinstruc = document.getElementById("instruksi")
...
instruc.addEventListener("click", (event) =>{
    menu1.style.display="none";
    openinstruc.style.display="block";

})

awal.addEventListener("click", (event) =>{
    menu1.style.display="block";
    openinstruc.style.display="none";
...
function gameOver() {
  ...
  setTimeout(() => {
    alert(`Game Over! para monster telah menyerang bumi, skormu adalah ${scoreCounter.innerText}!`)
